...
def page_1():
    ...
    container.header(":blue[**最爱玩的游戏：**]")
    container.subheader(":white[金铲铲之战]")
    container.image("金铲铲之战.jpg")
    with col1:
        container.header(":blue[**最喜欢看的电影：**]")
        container.subheader(":white[唐人街探案系列]")
        container.image(imgs_lst[0])
    with col2:
        container.header(":blue[**最喜欢的歌手：**]")
        container.subheader(":white[周杰伦]")
        container.image(imgs_lst[1])
def page_2():
    '''阿短的图片处理工具'''
